        ...
        if (
            ...
            for i in range(batch_size):
                ...
                for idx in selected_indices:
                    ...
                    new_cx, new_cy = (x1 + new_w_px / 2) / img_width, (
                        y1 + new_h_px / 2
                    ) / img_height
                    ...
                    if self.with_expand:
                        ...
                        expand_w, expand_h = int(new_w_px * alpha), int(
                            new_h_px * alpha
                        )
                        # check if out of bound: get the best offset in GT image
                        x1_expand, y1_expand = x1_src - max(
                            x1_src - expand_w, 0
                        ...
                        new_x1_expand, new_y1_expand = x1 - max(
                            x1 - x1_expand, 0
                ...
                for i in range(len(updated_targets)):
                    ...
                    for box in updated_targets[i]["boxes"]:
                        draw.rectangle(
                            [
                                int(
                                    box[0] * self.base_size[0]
                                    - (box[2] * self.base_size[1]) / 2
                                ),
                                int(
                                    box[1] * self.base_size[0]
                                    - (box[3] * self.base_size[1]) / 2
                                ),
                                int(
                                    box[0] * self.base_size[0]
                                    + (box[2] * self.base_size[1]) / 2
